module GainifyAPI
  ...
  #   asset = GainifyAPI::Asset.new(:key => 'assets/special.css', :theme_id => 12345)
  # 
  # Find by key:
  #   asset = GainifyAPI::Asset.find('assets/image.png', :params => {:theme_id => 12345})
  # 
  ...
  #     
  #   * set a URL from which Gainify will fetch the value:
  ...
  class Asset < Base
    ...
    #   GainifyAPI::Asset.find('layout/theme.liquid', :params => {:theme_id => 99})
    def self.find(*args)
    ...
    # For text assets, Gainify returns the data in the 'value' attribute.
