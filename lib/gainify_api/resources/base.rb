...
module GainifyAPI
  class Base < ActiveResource::Base
    ...
    self.headers['User-Agent'] = ["GainifyAPI/#{GainifyAPI::VERSION}",
    ...
    class << self
      ...
      def activate_session(session)
        ...
        self.headers.merge!('X-Gainify-Access-Token' => session.token)
      end

      def clear_session
        self.site = nil
        self.headers.delete('X-Gainify-Access-Token')
      end
