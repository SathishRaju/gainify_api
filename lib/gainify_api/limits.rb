  ...
  module Limits
    ...
    module ClassMethods
      ...
      CREDIT_LIMIT_HEADER_PARAM = {
        :shop => 'http_x_gainify_shop_api_call_limit'
      }
      ...
      # NOTE: subtracting 1 from credit_limit because I think GainifyAPI cuts off at 299 or shop limits.
      ...
      #
      def response
        Shop.current unless GainifyAPI::Base.connection.response
        GainifyAPI::Base.connection.response
      end
