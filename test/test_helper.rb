...
# setup GainifyAPI with fake api_key and secret
...
class Test::Unit::TestCase
  ...
  def setup
    ...
    GainifyAPI.constants.each do |const|
      begin
        const = "GainifyAPI::#{const}".constantize
    ...
    GainifyAPI::Base.password = nil
    GainifyAPI::Base.user = nil
  end
  ...
  def fake(endpoint, options={})
    ...
    url = if options.has_key?(:url)
      ...
      "https://this-is-my-test-shop.mygainify.com/admin/#{endpoint}#{extension}"
    end
