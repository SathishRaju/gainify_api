...
class AssetTest < Test::Unit::TestCase
  def test_get_assetss
    ...
    v = GainifyAPI::Asset.find(:all, :params => {:theme_id => 1})
  end
  ...
  def test_get_asset_namespaced
    ...
    v = GainifyAPI::Asset.find('templates/index.liquid', :params => {:theme_id => 1})
  end

  def test_get_asset
    fake "assets.json?asset%5Bkey%5D=templates%2Findex.liquid", :extension=> false, :method => :get, :body => load_fixture('asset')
    v = GainifyAPI::Asset.find('templates/index.liquid')
  end
end
