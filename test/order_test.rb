...
class OrderTest < Test::Unit::TestCase
  ...
  test "create should create order" do
    ...
    order = GainifyAPI::Order.create(line_items: [{quantity:1, variant_id:39072856}], financial_status:"authorized")
  ...
  test "get should get an order" do
    ...
    order = GainifyAPI::Order.find(450789469)
